...
relationship_to_0629G:
  - "0629G defines the full product direction including Map Theme Editor, Playlist Theme Editor, and Projection Lab positioning."
  - "0629H defines the immediate functional build — stripped to palette creation, editing, saving, and export only."
  - "0629H is the build target. 0629G is the product direction. Both are active."

deferred_from_this_build:
  - Projection Lab
  - Map Theme Editor
...
- **Where:** `WOS-share/COLORLAB/SPECS/active/0629H_COLORLAB_FunctionalPaletteTool_v1.0.0.md`
- **What:** Build the functional palette tool first: import images safely, generate palettes, edit/save palettes, and export usable assets. Strip governance, Projection Lab, Map Theme Editor, and Playlist Theme Editor from the primary UI entirely.
...
- **Sequence:** 0629H is the immediate build target. 0629G is the full product direction. Both are active. 0629H completes first.
