...
const CAP_PROFILE_DETAILS: Record<SprayCapId, ProfileDetails> = {
  ...
  "wiggly-needle": profile(3, 10, "needle", "raw", "splattery", "medium", "pronounced", "dense", "high", "loaded", "symmetric", "Specialty oscillating variant of Needle — deposition identical to Needle, plus a bounded deterministic lateral wander. Digital effect cap, not a physical-cap target; future Waveformer audio-modulation candidate."),
