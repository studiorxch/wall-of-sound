...
// 8 canonical surface palette entries. Each entry defines a colour, material
// class, and optional PBR scalars (null for Lambert materials).
// ──────────────────────────────────────────────────────────────────────────────
(function (global) {
  'use strict';
  ...
  console.log('[WOSPalette] ready — ' + Object.keys(WOS_PALETTE).length + ' entries');
})(window);
