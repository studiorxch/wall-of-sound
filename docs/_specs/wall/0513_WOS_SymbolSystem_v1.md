...
It produces and manages _symbol sets_ — reusable collections of authored glyphs that can be placed in the world as visual objects, triggered by audio collisions, painted as typographic runs, or composed into scene layers. A symbol set is the atom of WOS's creative visual language.
...
WOS.SymbolRenderer.renderString(
  ctx,
  symbolSet,
  text,
  x,
...
_End of spec — 0513_WOS_SymbolSystem_v1.0.0_
